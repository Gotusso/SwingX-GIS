/*
 * $Id: YahooImageSearchBeanInfo.java 40 2006-07-17 20:52:17Z rbair $
 *
...
public class YahooImageSearchBeanInfo extends BeanInfoSupport {
    ...
    protected void initialize() {
        ...
        bd.setName("Yahoo! Image Search");
        bd.setShortDescription("A JavaBean for searching for images using Yahoo!");
    ...
    public static EnumerationValue[] getFileFormatEnumValues() {
        ...
        results[0] = new EnumerationValue("<default>", FileFormat.ANY, "null");
        for (int i = 0; i < values.length; i++) {
            results[i + 1] = new EnumerationValue(values[i].name(), values[i],
                    "org.jdesktop.swingx.ws.yahoo.search.imagesearch.FileFormat" + values[i].name());
        }
        return results;
    }
}
