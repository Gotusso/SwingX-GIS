 ...
 * this interface are called at various points in the processing of the
 * background task.
 * 
 * @author rbair
 */
public interface BackgroundListener extends java.util.EventListener {
    /**
     * Always called on the EDT right before the background task actually
     * begins.
     */
     ...
     * running tasks are placed in. If you need to update the Swing GUI, you may
     * call the setProgress/setProgressPercent methods on BackgroundWorker, or
     * you may call the publish method on BackgroundWorker to cause some data to
     ...
     * processing of the background task (depending on how many times the
     * doInBackground method calls publish). This method will be called
     * concurrently with work going on in the doInBackground method.
     */
