 ...
 * extended XPath functions of the org.jdesktop.xpath.function package.
 * </p>
 * 
 * @author rbair
 */
public class XPathUtils {
     ...
     *             if the expression does not parse
     */
    public synchronized static SimpleNodeList getElements(XPathExpression expression, Node node)
            throws XPathExpressionException {
