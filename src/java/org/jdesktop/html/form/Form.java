...
public interface Form {
    /**
     * Returns the base url. The getAction() method is appended to this base url
     * to form the target url, if the action is a relative url.
     * 
     ...
     * 
     * @return a string representing the url to use. This may be a relative or
     *         absolute url.
     */
     ...
     * 
     * @return an array of <code>Input</code>s. The ordering of elements in this
     ...
     * <code>Input</code> has this name, it is unspecified which will be
     * returned.
     * 
