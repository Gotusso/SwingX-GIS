...
public abstract class AbstractForm extends AbstractBean implements Form {
    ...
    private Encoding encoding; // this is initialized in the various
                               // constructors to be not null

    /**
     * Create a new AbstractForm with the given baseUrl and set of Inputs. The
     * baseUrl is necessary for evaluating action urls that are relative.
     * 
     * @param baseUrl
     *            the base url. May be null (but then relative action paths will
     *            fail).
     * @param inputs
     *            the set of inputs. May be null.
     */
    ...
    /**
     * Create a new AbstractForm with the given baseUrl and array of Inputs. The
     * baseUrl is necessary for evaluating action urls that are relative.
     * 
     * @param baseUrl
     *            the base url. May be null (but then relative action paths will
     *            fail).
     * @param inputs
     *            the array of inputs. May be null.
     */
     ...
     *            fail).
     * @param encoding
     *            the encoding to use. If null, then UrlEncoded is used
     * @param inputs
     *            the array of inputs. May be null.
     */
