...
public interface FileInput extends Input {
    ...
    /**
     * The filename associated with this file. This may be null, but it is
     * strongly encouraged to provide a file name for uploaded files.
     * 
    ...
    /**
     * Returns the value represented by this FileItem as an input stream. If
     * null, then the stream is ignored when constructing the response. If a bad
     * file was chosen, then this value may be null.
     * 
     * @return
     */
