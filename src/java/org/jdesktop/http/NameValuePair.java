...
/**
 * Represents a name/value pair. Both the name and value properties are bound
 * (meaning a PropertyChangeEvent will be fired when their values change).
 * 
 * @author rbair
 */
public class NameValuePair extends AbstractBean implements Cloneable {
    ...
    /**
     * Creates a new instance of NameValuePair. Both name and value will be
     * null.
     */
    ...
    /**
     * Creates a new instance of NameValuePair, using the supplied name and
     * value.
     * 
     * @param name
     *            the name to use. May be null.
     * @param value
