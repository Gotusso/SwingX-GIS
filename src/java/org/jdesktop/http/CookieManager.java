...
public class CookieManager extends CookieHandler {
    ...
    public void put(URI uri, Map<String, List<String>> responseHeaders) throws IOException {
        ...
        for (Map.Entry<String, List<String>> entry : responseHeaders.entrySet()) {
            ...
            // TODO also need to inspect the Cache-control header for rules on
            // whether and how to cache the cookie
            ...
            if ("Set-Cookie".equalsIgnoreCase(entry.getKey())) {
                ...
                for (String v : entry.getValue()) {
                    ...
                    // if the cookie has a max-age of 0, then simply clear the
                    // cache
                    // of this cookie.
                    if (c.getMaxAge() == 0) {
                        cookies.remove(w);
    ...
    /**
     * For two strings that represent paths, p1 and p2, p1 path-matches p2 if p2
     * is a prefix of p1 (including the case where p1 and p2 string-compare
