...
class DefaultSecurityHandler implements SecurityHandler {
    private String message = "<html><body><p style=\"text-align:justify\">"
            + "<b>Java can''t verify the identity of the website " + "\"{0}\".</b></p>"
            + "<p style=\"text-align:justify;font:11\">" + "The certificate for this website was signed by "
    ...
    private JDialog createDialog() {
        ...
        JLabel iconLabel = new JLabel(new ImageIcon(getClass().getResource("resources/security-warning.png")));
        ...
        gbl.addLayoutComponent(iconLabel, new GridBagConstraints(0, 0, 1, 2, 0.0, 0.0, GridBagConstraints.NORTH,
                GridBagConstraints.BOTH, new Insets(0, 24, 0, 0), 0, 0));
        gbl.addLayoutComponent(messagePane, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.NORTH,
                GridBagConstraints.BOTH, new Insets(0, 24, 0, 11), 0, 0));
        gbl.addLayoutComponent(buttonPanel, new GridBagConstraints(0, 2, 2, 1, 0.0, 1.0, GridBagConstraints.SOUTH,
                GridBagConstraints.HORIZONTAL, new Insets(24, 12, 11, 11), 0, 0));
        dlg.setLayout(gbl);

        GridBagLayout panelLayout = new GridBagLayout();
        panelLayout.addLayoutComponent(showCertButton, new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0,
                GridBagConstraints.LINE_START, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
        panelLayout.addLayoutComponent(cancelButton, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
        panelLayout.addLayoutComponent(continueButton, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
