...
public class BackgroundEvent extends EventObject {
    ...
    /**
     * @return data associated with the event. In particular, this is used in
     *         the <code>process</code> method of the BackgroundListener to
     *         retrieve data that is to be displayed in the GUI.
     */
