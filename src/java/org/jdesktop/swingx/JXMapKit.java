...
public class JXMapKit extends JXPanel {
    ...
    public JXMapKit() {
        ...
        try {
            final Icon minusIcon = new ImageIcon(getClass().getResource("/org/jdesktop/swingx/mapviewer/resources/minus.png"));
            this.zoomOutButton.setIcon(minusIcon);
            this.zoomOutButton.setText("");
            final Icon plusIcon = new ImageIcon(getClass().getResource("/org/jdesktop/swingx/mapviewer/resources/plus.png"));
    ...
    private void zoomInButtonActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_zoomInButtonActionPerformed
        // TODO add your handling code here:
    }// GEN-LAST:event_zoomInButtonActionPerformed

    private void zoomSliderStateChanged(final javax.swing.event.ChangeEvent evt) {// GEN-FIRST:event_zoomSliderStateChanged
        if (!zoomChanging) {
    ...
    private void rebuildMainMapOverlay() {
         ...
         */
        cp.setPainters( new AbstractPainter[]{} /* Fuck you. dataProviderCreditPainter, addressLocationPainter*/);
    ...
    public void setDefaultProvider(final DefaultProviders prov) {
        ...
        if (prov == DefaultProviders.OpenStreetMaps) {
            final int max = 17;
            final TileFactoryInfo info = new TileFactoryInfo(1, max - 2, max, 256, true, true, // tile
                                                                                         // size
                                                                                         // is
                                                                                         // 256
                                                                                         // and
