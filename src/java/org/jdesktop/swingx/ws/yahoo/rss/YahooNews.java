...
/**
 * <p>
 * A simple JavaBean encapsulating access to the Yahoo! News RSS feeds. To use
 * this class, you simply need to set the feedName property and call the
 ...
 * href="http://news.yahoo.com/rss">Yahoo!</a> for more information about
...
public class YahooNews extends YahooRSS {
    ...
    /**
     * Sets the name of the feed to read from Yahoo! News. Several common
     * feednames are listed in this class (such as YahooNews.SPORTS).
     * 
     * @param feedName
     *            name of a yahoo feed. This cannot be null or contain only
     *            whitespace
     */
