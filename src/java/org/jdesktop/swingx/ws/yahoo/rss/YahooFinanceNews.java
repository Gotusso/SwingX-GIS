 ...
 * To use this class, you simply need to set the feedName property and call the
 * <code>readFeed</code> method. <code>readFeed</code> may be a long running
 * operation, so be sure to wrap access to it in some way, such as with
 * SwingWorker or BackgroundWorker.
 * </p>
 * 
 * <p>
 * There are many valid feedNames, and the list is ever growing. Some common
 * popular names are listed as public static Strings in this class. See <a
 * href="http://finance.yahoo.com/rssindex">Yahoo!</a> for more information
 * about specific feeds that are available. By default, the MOST_POPULAR feed is
 * used.
 * 
 * <p>
 * This class is very similar in style an approach to the YahooNews class, it
 * simply maintains a different namespace and URL structure.
 * </p>
 * 
 * @author rbair
 */
public class YahooFinanceNews extends YahooRSS {
    ...
    /**
     * Sets the name of the feed to read from Yahoo! Finance News. Several
     * common feednames are listed in this class (such as YahooNews.FUNDS).
     * 
     * @param feedName
     *            name of a Yahoo! finance feed. This cannot be null or contain
     *            only whitespace
     */
