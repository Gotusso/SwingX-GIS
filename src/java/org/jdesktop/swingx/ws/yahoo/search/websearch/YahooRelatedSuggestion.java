...
/**
 * <p>
 * A non visual JavaBean for using the <a href="">Yahoo! Related Suggestion</a>
 * service. From the docs: "The Related Suggestion service returns suggested
 * queries to extend the power of a submitted query, providing variations on a
 * theme to help you dig deeper."
 * </p>
 * 
 * @author rbair
 */
