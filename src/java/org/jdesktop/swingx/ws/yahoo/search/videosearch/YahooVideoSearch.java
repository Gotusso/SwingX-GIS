...
/**
 * <p>
 * A non visual JavaBean which allows you to use Yahoo! to search for videos on
 * the internet. See <a
 * href="http://developer.yahoo.com/search/video/V1/videoSearch.html"> the
 * Yahoo! documentation for this service</a> for more information.
 * </p>
 * 
 * @author rbair
 */
public final class YahooVideoSearch extends YahooSearch {
     ...
     * href="http://developer.yahoo.com/search/video/V1/videoSearch.html"
    ...
    private final class Parser extends DefaultHandler {
        ...
        public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
            if ("ResultSet".equals(qName)) {
                results = new ResultsArrayList<Result>(YahooVideoSearch.this, Integer.parseInt(attributes
