...
/**
 * Non visual JavaBean for calling Yahoo! context search and retrieving the
 * search results. To use, simply specify a query, a context, and your appId.
 * (AppId is a value you get from Yahoo -- each application must have an id).
 * 
 * <p>
 * This bean is related to the <a
 * href="http://developer.yahoo.com/search/web/V1/contextSearch.html"> Yahoo!
 * Web Search</a> web service.
 * 
 * @author rbair
 */
public final class YahooContextSearch extends YahooWebSearchService {
     ...
     * href="http://developer.yahoo.com/search/web/V1/contextSearch.html"
     * >Yahoo!</a> for more info
     */
    ...
    private final class Parser extends DefaultHandler {
        ...
        public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
            if ("ResultSet".equals(qName)) {
                results = new ResultsArrayList<Result>(YahooContextSearch.this, Integer.parseInt(attributes
    ...
    // System.out.println(count + results.getFirstResultPosition() + ".\t" +
    // r.title);
