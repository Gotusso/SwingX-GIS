/*
 * $Id: YahooWebSearch.java 25 2006-07-17 18:31:29Z rbair $
 *
...
/**
 * Non visual JavaBean for calling Yahoo! search and retrieving the search
 * results. To use, simply specify a query and your appId. (AppId is a value you
 * get from Yahoo -- each application must have an id).
 * 
 * <p>
 * This bean is related to the <a
 * href="http://developer.yahoo.com/search/web/V1/webSearch.html"> Yahoo! Web
 * Search</a> web service.
 * 
 * @author rbair
 */
public final class YahooWebSearch extends YahooWebSearchService<YahooWebSearch.Result> {
    ...
    // TODO add support (haven't added yet because of lack of JavaBeans support
    // in IDEs)
    ...
    protected final Map getParameters() {
        ...
        if (region != null) {
            params.put("region", region.getCode());
        }
        if (type != null) {
        ...
        if (subscriptions.size() > 0) {
            ...
            for (Subscription sub : subscriptions) {
                if (buffer.length() > 0) {
                    ...
                    buffer.append(sub.getCode());
                } else {
                    buffer.append(sub.getCode());
                }
            }
            params.put("subscription", buffer.toString());
        }
        return params;
    }
     ...
     * searches can be executed. You must get an app id from yahoo. See <a
     * href="http://developer.yahoo.com/">the Yahoo docs</a> for more info.
     * 
     * @param appId
     */
    ...
    /**
     * Sets the search query to use. This follows all the same conventions as
     * the web based Yahoo! search engine
     */
    ...
    /**
     * Sets the region code. See <a
     * href="http://developer.yahoo.com/search/web/V1/webSearch.html">Yahoo!</a>
     * for more info
     */
    ...
    /**
     * Sets the adult ok boolean. See <a
     * href="http://developer.yahoo.com/search/web/V1/webSearch.html">Yahoo!</a>
     * for more info
     */
    ...
    /**
     * Sets the similar ok flag. See <a
     * href="http://developer.yahoo.com/search/web/V1/webSearch.html">Yahoo!</a>
     * for more info
     */
    ...
    private final class Parser extends DefaultHandler {
        ...
        public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
            if ("ResultSet".equals(qName)) {
                results = new ResultsArrayList<Result>(YahooWebSearch.this, Integer.parseInt(attributes
                        .getValue("totalResultsAvailable")), Integer.parseInt(attributes
                        .getValue("firstResultPosition")));
    ...
    // yahoo.query = "world cup 2006 head butt Materazzi Zidane";
    ...
    //
    // int count = 1;
    // while (count < 300 && results.isHasNextPage()) {
    // for (int i=0; i<results.size(); i++) {
    // Result r = results.get(i);
    // System.out.println(count++ /*+ pp.results.firstResultPosition*/ + ".\t" +
    // r.getTitle());
    // System.out.println("\t" + r.getSummary());
    // System.out.println("\t" + r.getModDate());
    // }
    // results.nextPage();
    // }
    // }
