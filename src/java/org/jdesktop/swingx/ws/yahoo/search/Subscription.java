...
public enum Subscription {
    CONSUMER_REPORTS("cr"), FT_COM("ft"), FORRESTER_RESEARCH("forrester"), IEEE("ieee"), NEW_ENGLAND_JOURNAL_OF_MEDICINE(
            "nejm"), THE_STREET_COM("thestreet"), WALL_STREET_JOURNAL("wsj");
