...
/**
 * This is a SAX document handler that is used to build an HTML document. It can
 * build a document from any SAX parser.
 * 
 ...
 * 
 * @version $Revision: 134 $ $Date: 2006-12-19 19:39:48 +0100 (mar, 19 dic 2006)
 *          $
...
class HTMLBuilder extends DefaultHandler2 {
    ...
    /**
     * The current node in the document into which elements, text and other
     * nodes will be inserted. This starts as the document iself and reflects
     * each element that is currently being parsed.
     */
    protected ElementImpl _current;

    /**
     * A reference to the current locator, this is generally the parser itself.
     * The locator is used to locate errors and identify the source locations of
     * elements.
     */
    private Locator _locator;

    /**
     * Applies only to whitespace appearing between element tags in element
     * content, as per the SAX definition, and true by default.
     */
    private boolean _ignoreWhitespace = true;

    /**
     * Indicates whether finished building a document. If so, can start building
     * another document. Must be initially true to get the first document
     * processed.
     */
    private boolean _done = true;

    /**
     * The document is only created the same time as the document element,
     * however, certain nodes may precede the document element (comment and PI),
    ...
    public synchronized void startElement(String uri, String localName, String qName, Attributes attrList)
            throws SAXException {
        ElementImpl elem;
        int i;
        ...
        // If this is the root element, this is the time to create a new
        // document,
        // because only know we know the document element name and namespace
        // URI.
        if (_document == null) {
            ...
            // Insert nodes (comment and PI) that appear before the root
            // element.
            ...
            // This is a state error, indicates that document has been parsed in
            // full,
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        // Move up to the parent element. When you reach the top (closing the
        // root element).
    ...
    public void processingInstruction(String target, String instruction) throws SAXException {
        ...
        // Processing instruction may appear before the document element (in
        // fact, before the
        // document has been created, or after the document element has been
        // closed.
