...
/**
 * <p>
 * An HTML DOM {@link javax.xml.parsers.DocumentBuilder} implementation that
 * does not require the factory pattern for creation. Most of the time calling
 * one of the static <code>simpleParse</code> methods is all that is required.
 * </p>
 * 
 * <p>
 * This implementation requires a normal DOM parser. It is not suitable for
 * parsing arbitrary HTML documents, even those documents which conform to the
 * various HTML specifications. Rather, it requires a preproccesor to first
 * clean up the HTML such that it can be parsed into a DOM.
 * </p>
 * 
 * @author rbair
 */
public class SimpleHtmlDocumentBuilder extends DocumentBuilder {
    ...
    /**
     * Create a new SimpleHtmlDocumentBuilder. SimpleHtmlDocumentBuilder will
     * delegate parsing to the default DocumentBuilder constructed via the
     ...
     * HTML DOM {@link SimpleHtmlDocument} object. An
     * <code>IllegalArgumentException</code> is thrown if the String is null.
     * </p>
     * 
     * <p>
     * <strong>NOTE:</strong> this implementation requires a normal DOM parser.
     * It is not suitable for parsing arbitrary HTML documents, even those
     * documents which conform to the various HTML specifications. Rather, it
     * requires a preproccesor to first clean up the HTML such that it can be
     * parsed into a DOM.
     * </p>
     * 
     * @param html
     *            String containing the content to be parsed. Must be valid
     *            XHTML
     * 
     * @return <code>SimpleHtmlDocument</code> result of parsing the String
     * 
     * @throws IOException
     ...
     *             When <code>html</code> is <code>null</code>
     * 
     ...
     * a new HTML DOM {@link SimpleDocument} object. An
     ...
     * document and return a new HTML DOM {@link SimpleHtmlDocument} object. An
     * <code>IllegalArgumentException</code> is thrown if the
    ...
    /**
     * <p>
     * Parse the content of the given URL as an XML document and return a new
     * HTML DOM {@link SimpleHtmlDocument} object. An
     * <code>IllegalArgumentException</code> is thrown if the URI is
     * <code>null</code> null.
     * </p>
     * 
     * <p>
     ...
     *             If any parse errors occur.
     * @throws IllegalArgumentException
     *             When <code>url</code> is <code>null</code>
     * 
     * @see org.xml.sax.DocumentHandler
     */
     ...
     * 
     * @param xml
     *            String containing the content to be parsed.
     * 
     * @return <code>SimpleDocument</code> result of parsing the String
     * 
     * @throws IOException
     *             If any IO errors occur.
     * @throws SAXException
     *             If any parse errors occur.
     * @throws IllegalArgumentException
     *             When <code>xml</code> is <code>null</code>
     * 
     * @see org.xml.sax.DocumentHandler
     */
