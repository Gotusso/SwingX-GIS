...
/**
 * <p>
 * An implementation of {@link org.w3c.dom.NodeList} which also implements
 * {@link Iterable}. This allows you to use a SimpleNodeList in an enhanced for
 * loop, such as:
 * 
 * <pre>
 * <code>
 ...
 * 
 * <p>
 * SimpleNodeList wraps a source NodeList. Thus, any NodeList can be adapted for
 * use with enhanced for loops by wrapping it in a SimpleNodeList.
 * </p>
 * 
 * @author rbair
 */
