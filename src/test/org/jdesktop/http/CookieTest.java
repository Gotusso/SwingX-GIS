...
public class CookieTest extends TestCase {
    ...
    public void testParseCookie() {
        ...
        c = Cookie
                .parseCookie("session-id=000-0000000-0000000; path=/; domain=.amazon.com; expires=Mon Mar 05 08:00:00 2007 GMT");
        ...
        c = Cookie
                .parseCookie("B=9ta9mt92u6c95&b=3&s=kg; expires=Tue, 02-Jun-2037 20:00:00 GMT; path=/; domain=.yahoo.com");
        ...
        c = Cookie
                .parseCookie("MSPOK=uuid-21d927cf-1db4-4293-aace-b0447934e618; domain=login.live.com;path=/;version=1");
        ...
        c = Cookie
                .parseCookie("ebay=%5Esbf%3D0%5Epim%3D-1%5Erda%3D1172517158256.%5Esgj%3Dff77fd611100a06748147364ffd60815%5E; Domain=.ebay.com; Path=/");
        assertEquals("ebay", c.getName());
        assertEquals("%5Esbf%3D0%5Epim%3D-1%5Erda%3D1172517158256.%5Esgj%3Dff77fd611100a06748147364ffd60815%5E",
                c.getValue());
        assertFalse(c.isSecure());
        assertEquals("/", c.getPath());
        ...
        c = Cookie
                .parseCookie("PREF=ID=81cbf510de46a462:TM=1172517158:LM=1172517158:S=eKbn3ZQyDp-hoj7Q; expires=Sun, 17-Jan-2038 19:14:07 GMT; path=/; domain=.google.com");
        ...
        c = Cookie
                .parseCookie("AnalysisUserId=37371172517158; domain=.nike.com; path=/; expires=Friday, 31-Dec-2010 23:59:59 GMT");
